	...
	return (
		<>
			...
			<ScrollView contentContainerStyle={[styles.scrollContainer]}>
						...
						<View style={styles.halfContainer}>
								...
								<View style={styles.badgeBox}>
									...
									<SpaceView mb={8}>
										<View style={[layoutStyle.row, layoutStyle.alignCenter]}>
											<CommonText fontWeight={'700'}>직업</CommonText>
							...
							<TouchableOpacity style={styles.halfItemRight}>
								<View style={styles.badgeBox}>
									...
									<SpaceView mb={8}>
										<View style={[layoutStyle.row, layoutStyle.alignCenter]}>
											<CommonText fontWeight={'700'}>학위</CommonText>
											<Image source={ICON.arrRight} style={styles.iconSize} />
										</View>
									</SpaceView>
						...
						<View style={styles.halfContainer}>
							...
							<TouchableOpacity style={styles.halfItemRight}>
								<View style={styles.badgeBox}>
									...
									<SpaceView mb={8}>
										<View style={[layoutStyle.row, layoutStyle.alignCenter]}>
											<CommonText fontWeight={'700'}>차량</CommonText>
											<Image source={ICON.arrRight} style={styles.iconSize} />
										</View>
									</SpaceView>
				...
				<SpaceView mb={24}>
					<CommonBtn value={'다음 (2/4)'} type={'primary'} />
				</SpaceView>
			</ScrollView>
		</>
	);
